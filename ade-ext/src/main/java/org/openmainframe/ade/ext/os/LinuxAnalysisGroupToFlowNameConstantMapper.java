 ...
 */
public class LinuxAnalysisGroupToFlowNameConstantMapper extends AnalysisGroupToFlowNameConstantMapper {

    public LinuxAnalysisGroupToFlowNameConstantMapper() {
        super("LINUX");
    }
