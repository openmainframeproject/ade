...
public class AdeUtilMain extends org.openmainframe.ade.main.AdeUtilMain {
	...
	protected void parseArgs(String[] args) throws AdeUsageException {
		...
		if (line.hasOption('d')) {
			m_inputFile = new File(line.getOptionValue(DumpModelDebugOpt
					.getLongOpt()));
			m_cmd = "debugPrint";
		}
	...
	protected boolean doControlLogic() throws AdeException {
		...
		final AdeUtilMainOperator operator = AdeUtilMainOperator
				.getOperatorType(m_cmd);
	...
	private boolean doDebugModel() throws AdeException, AdeInternalException,
			AdeException {
	...
	public enum AdeUtilMainOperator {
		...
		public static AdeUtilMainOperator getOperatorType(String operatorName)
				throws AdeException {
	...
	private static void usageError(String errorMsg) throws AdeUsageException {
		...
		System.err.println();
		System.err
				.println("-b returns the version of the database schema in the database pointeed to by ADE in flowlayout.xml");
		System.err.println();
		System.err
				.println("-d prints a text summary of the model stored in the file specified");
		System.err.println();
		System.err
				.println("-f checks the flowlayout.xml file specified against the xsd file");
		System.err.println();
