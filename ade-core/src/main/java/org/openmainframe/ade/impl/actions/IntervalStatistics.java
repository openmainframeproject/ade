...
class IntervalStatistics extends SplitterBySourceGroup implements IMessageInstanceTarget {

    IntervalStatistics() {
        super(Action.INTERVAL_STATISTICS);
    }

    @Override
    public void endOfStream() throws AdeException, AdeFlowException {
        super.endOfStream();
        StatsCollectorFactory.closeAllIntervalStatCollectors();
    }
