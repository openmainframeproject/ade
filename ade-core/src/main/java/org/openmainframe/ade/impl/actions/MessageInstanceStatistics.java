...
class MessageInstanceStatistics extends SplitterBySourceGroup implements IMessageInstanceTarget {

    MessageInstanceStatistics() {
        super(Action.MESSAGE_INSTANCE_STATISTICS);
    }
