...
public abstract class FixedMessageScorer extends MessageScorer {

    /**
     * 
     */
    private static final long serialVersionUID = -2972865353924261849L;

    public FixedMessageScorer() {
        super();
    }
